...
function addButtonListeners() {
  ...
  $('.speak-button').on('click', function () {
    ...
    const desiredVoice = voices.find(voice => voice.name === "Microsoft Aria Online (Natural) - English (United States)");

    if (desiredVoice) {
        utterance.voice = desiredVoice; // Set the voice
        utterance.lang = desiredVoice.lang; // Ensure the language matches
    } else {
        console.warn('Microsoft David voice not found. Using default voice.');
    }

    // Manage speech synthesis
...
// Ensure the voices are loaded before attempting to use them

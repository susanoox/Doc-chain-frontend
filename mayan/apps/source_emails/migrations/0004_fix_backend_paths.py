...
SOURCE_BACKEND_MAPPING = {
    'mayan.apps.sources.source_backends.SourceBackendIMAPEmail': 'mayan.apps.source_emails.source_backends.imap_source_backends.SourceBackendIMAPEmail',
    'mayan.apps.sources.source_backends.SourceBackendPOP3Email': 'mayan.apps.source_emails.source_backends.pop3_source_backends.SourceBackendPOP3Email'
}
...
class Migration(migrations.Migration):
    dependencies = [
        ('source_emails', '0003_fix_backend_paths'),
    ]

...
SOURCE_BACKEND_MAPPING = {
    'mayan.apps.source_web_forms.source_backends.web_form_backends.SourceBackendWebForm': 'mayan.apps.source_web_forms.source_backends.SourceBackendWebForm'
}
...
class Migration(migrations.Migration):
    dependencies = [
        ('source_web_forms', '0001_update_source_backend_paths')
    ]

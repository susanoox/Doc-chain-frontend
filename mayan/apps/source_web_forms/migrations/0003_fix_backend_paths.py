...
SOURCE_BACKEND_MAPPING = {
    'mayan.apps.sources.source_backends.SourceBackendWebForm': 'mayan.apps.source_web_forms.source_backends.SourceBackendWebForm'
}
...
class Migration(migrations.Migration):
    dependencies = [
        ('source_web_forms', '0002_fix_backend_paths')
    ]

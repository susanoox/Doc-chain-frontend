...
urlpatterns_document_files = [
    re_path(
        route=r'^documents/files/(?P<document_file_id>\d+)/content/$',
        name='document_file_content_view',
        view=DocumentFileContentView.as_view()
    ),
    re_path(
        route=r'^documents/files/(?P<document_file_id>\d+)/content/delete/$',
        name='document_file_content_single_delete',
        view=DocumentFileContentDeleteView.as_view()
    ),
    re_path(
        route=r'^documents/files/multiple/content/delete/$',
        name='document_file_content_multiple_delete',
        view=DocumentFileContentDeleteView.as_view()
    ),
    re_path(
        route=r'^documents/files/(?P<document_file_id>\d+)/content/download/$',
    ...
    re_path(
        route=r'^documents/files/pages/(?P<document_file_page_id>\d+)/content/$',
...
urlpatterns_document_types = [
    ...
    re_path(
        route=r'^document_types/(?P<document_type_id>\d+)/parsing/settings/$',
...
api_urls = [
    ...
    re_path(
        route=r'^documents/(?P<document_id>\d+)/files/(?P<document_file_id>\d+)/pages/(?P<document_file_page_id>\d+)/content/$',

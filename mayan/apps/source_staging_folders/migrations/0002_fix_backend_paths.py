...
SOURCE_BACKEND_MAPPING = {
    'mayan.apps.source_staging_folders.source_backends.staging_folder_backends.SourceBackendStagingFolder': 'mayan.apps.source_staging_folders.source_backends.SourceBackendStagingFolder'
}

...
SOURCE_BACKEND_MAPPING = {
    'mayan.apps.source_watch_folders.source_backends.watch_folder_backends.SourceBackendWatchFolder': 'mayan.apps.source_watch_folders.source_backends.SourceBackendWatchFolder'
}
...
class Migration(migrations.Migration):
    dependencies = [
        ('source_watch_folders', '0001_update_source_backend_paths')
    ]
